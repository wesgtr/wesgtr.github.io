...
const apiURL = "https://api.openweathermap.org/data/2.5/weather?lat=42.0381059&lon=-111.4005351&units=imperial&APPID=f231a64fe0bf673894728e2e53615a71";
fetch(apiURL)
...
//Forecast Code
const forecastURL = 'https://api.openweathermap.org/data/2.5/forecast?lat=42.0381059&lon=-111.4005351&units=imperial&appid=f231a64fe0bf673894728e2e53615a71';
fetch(forecastURL)
    .then((response) => response.json())
    .then((jsObject) => {
